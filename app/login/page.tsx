...
import { triggerHaptic, useDeviceDetection } from '@/lib/device-detection';
    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-md relative z-10">
          ...
          <Card className="bg-mint border-4 border-primary shadow-2xl   relative overflow-hidden " style={{animationDelay: '0.1s'}}>
            {/* Shine Effect */}
            ...
            <CardContent className="space-y-4 sm:space-y-6 relative z-10">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                {/* Apple Sign In - Only show on iOS devices */}
                {deviceInfo.isIOS && (
                  <Button
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full px-4 py-3 pr-12 border-2 border-foreground/20 rounded-lg focus:outline-none focus:border-primary font-bold bg-white"
                      disabled={loading}
                      required
                    />
                    <button
