                                ...
                                >
                                  ...
                                  <CardHeader className="relative z-10">
                                    <div className="flex justify-between items-start mb-3">
                                      <Badge className={`${getStatusColor(getDisplayStatus(order))} font-black uppercase text-xs sm:text-sm px-3 py-1.5 flex items-center gap-1`}>
                                  ...
                                  <CardContent className="space-y-4 relative z-10">
                                    ...
                                    <div className="p-3 sm:p-4 bg-white rounded-xl border-2 border-secondary/40">
                                      <div className="font-black uppercase text-xs text-muted-foreground mb-3 flex items-center gap-1"><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" /></svg> What You Bought</div>
                                    ...
                                    <div className="p-3 sm:p-4 bg-white rounded-xl border-2 border-secondary">
                                      <div className="flex items-start gap-2">
                                        <svg className="w-6 h-6 text-secondary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                        <div>
                                    ...
                                    <Link href={`/install/${order.id}`} className="block">
                                      <Button className="w-full btn-lumbus bg-primary text-white hover:bg-primary/90 hover:scale-105 active:scale-105 font-black text-lg sm:text-xl py-5 sm:py-6 shadow-xl transition-all flex items-center justify-center gap-2">
                                        <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" /></svg>
                                        ACTIVATE SIM NOW
                                      </Button>
                                    </Link>
                                  </CardContent>
                      ...
                      <CardContent className="space-y-4 relative z-10">
                        ...
                        <div className="p-3 sm:p-4 bg-white rounded-xl">
                          <div className="flex justify-between items-center mb-2">
                            <span className="font-black uppercase text-xs flex items-center gap-1"><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg> Data Usage</span>
                            {order.activated_at && (
                              <button
                                onClick={() => refreshUsageData(order.id)}
                                disabled={refreshingUsage[order.id]}
                                className="text-xs font-black text-primary hover:text-primary/80 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
                              >
                                <svg className={`w-3 h-3 ${refreshingUsage[order.id] ? 'animate-spin' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" /></svg>
                          ...
                          {dataUsedPercentage > 80 && dataUsedPercentage < 100 && (
                            <p className="text-xs font-bold text-destructive mt-2 flex items-center gap-1">
                              ...
                              Running low on data! Consider topping up.
                            </p>
                          )}
                        </div>
                        ...
                        <div className="p-3 sm:p-4 bg-white rounded-xl">
                          ...
                          {order.activated_at && daysRemaining > 0 && daysRemaining <= 5 && (
                            <p className="text-xs font-bold text-destructive mt-2 flex items-center gap-1">
                              <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg>
                              Expiring soon! Purchase a new plan to stay connected.
                            </p>
                          )}
                          ...
                          {daysRemaining <= 0 && (
                            <p className="text-xs font-bold text-destructive mt-2 flex items-center gap-1">
                              <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg>
                              This plan has expired. Purchase a new plan to stay connected.
                            </p>
                          )}
                        </div>
                        ...
                        {order.activated_at && (
                          <div className="p-3 sm:p-4 bg-white rounded-xl border-2 border-primary/20">
                            ...
                            >
                              <span className="font-black uppercase text-xs flex items-center gap-1"><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" /></svg> Quick Help & Instructions</span>
                            ...
                            {showQuickHelp[order.id] && (
                              <div className="mt-4 space-y-3 text-sm">
                                ...
                                <div className="p-3 bg-mint rounded-lg">
                                  <div className="font-black mb-2 flex items-center gap-1"><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg> Check Installation Status</div>
                                  <p className="text-xs font-bold text-muted-foreground">
                        ...
                        <div className="flex gap-2 sm:gap-3">
                          ...
                          {!order.activated_at ? (
                            <Link href={`/install/${order.id}`} className="flex-1">
                              <Button className="w-full btn-lumbus bg-primary text-white hover:bg-primary/90 font-black text-base sm:text-lg py-4 sm:py-5 flex items-center justify-center gap-2">
