  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue={defaultTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-mint border-2 sm:border-4 border-primary p-1 sm:p-1.5">
      ...
      <TabsContent value="ios" className="space-y-4 sm:space-y-6">
        ...
        {supportsUniversalLink && (
          <Card className="bg-gradient-to-br from-purple to-purple/80 border-2 sm:border-4 border-foreground shadow-xl">
            <CardHeader>
              <div className="flex items-center justify-between flex-wrap gap-2">
                <CardTitle className="text-lg sm:text-xl md:text-2xl font-black uppercase">
                  ⚡ METHOD 1: INSTANT INSTALL
                </CardTitle>
                <Badge className="bg-foreground text-white font-black uppercase text-xs px-3 py-1.5">
                  RECOMMENDED
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-white/90 p-4 sm:p-6 rounded-xl space-y-3">
                <p className="font-black text-sm sm:text-base uppercase text-center">
                  📱 For iOS 17.4 or newer
                </p>
                <ol className="space-y-3 text-sm sm:text-base font-bold">
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center font-black text-xs">1</span>
                    <span>Tap the button below to open Settings automatically</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center font-black text-xs">2</span>
                    <span>Tap "Continue" when prompted</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center font-black text-xs">3</span>
                    <span>Label your eSIM (e.g., "Travel Data")</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center font-black text-xs">4</span>
              ...
              <Button
                ...
                className="w-full btn-lumbus bg-foreground text-white hover:bg-foreground/90 active:bg-foreground/90 text-base sm:text-lg md:text-xl py-6 sm:py-7 md:py-8 font-black shadow-xl hover:scale-105 active:scale-105 transition-all touch-manipulation"
              >
                🚀 INSTALL eSIM NOW
              </Button>
        ...
        {/* Method 2: QR Code */}
        <Card className="bg-gradient-to-br from-cyan to-cyan/80 border-2 sm:border-4 border-foreground shadow-xl">
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl md:text-2xl font-black uppercase">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center">
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl inline-block shadow-2xl border-2 sm:border-4 border-foreground">
                <Image
                  src={qrUrl}
                  alt="eSIM QR Code"
                  width={280}
                  height={280}
                  className="mx-auto w-full max-w-[220px] sm:max-w-[280px] h-auto"
                  priority
                />
              </div>
              <div className="mt-4 p-3 sm:p-4 bg-yellow/80 rounded-xl border-2 border-foreground/20">
        ...
        <Card className="bg-gradient-to-br from-yellow to-yellow/80 border-2 sm:border-4 border-foreground shadow-xl">
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl md:text-2xl font-black uppercase">
              ⌨️ {supportsUniversalLink ? 'METHOD 3:' : 'METHOD 2:'} MANUAL ENTRY
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <Accordion type="single" collapsible className="bg-white/90 rounded-xl">
              <AccordionItem value="manual" className="border-none">
                <AccordionTrigger className="font-black uppercase text-sm sm:text-base px-4 hover:no-underline">
                  📋 Show Manual Entry Instructions
                </AccordionTrigger>
                <AccordionContent className="space-y-4 px-4 pb-4">
                  <div className="space-y-3 text-sm sm:text-base font-bold mb-4">
                  ...
                  <div className="mt-4 p-3 bg-mint/50 rounded-lg border-2 border-foreground/10">
          ...
          <CardContent className="space-y-4">
            <div className="bg-white/90 p-4 sm:p-6 rounded-xl space-y-3">
              ...
              <ol className="space-y-3 text-sm sm:text-base font-bold">
                ...
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center font-black text-xs">5</span>
            ...
            <div className="text-center">
              ...
              <div className="mt-4 p-3 sm:p-4 bg-cyan/80 rounded-xl border-2 border-foreground/20">
                <p className="font-black uppercase text-xs sm:text-sm">
                  💡 TIP: Take a screenshot to save this QR code
                </p>
              </div>
