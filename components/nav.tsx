  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 bg-white z-50 border-b border-foreground/10 shadow-sm">
        <div className="container mx-auto px-4 md:px-6 py-1 sm:py-1.5 md:py-1">
          <div className="flex justify-between items-center">
            ...
            >
              <div className="w-6 h-5 relative flex flex-col justify-between">
                <span className={`w-full h-0.5 bg-foreground ${mobileMenuOpen ? 'rotate-45 translate-y-2' : ''}`} />
                <span className={`w-full h-0.5 bg-foreground ${mobileMenuOpen ? 'opacity-0' : ''}`} />
                <span className={`w-full h-0.5 bg-foreground ${mobileMenuOpen ? '-rotate-45 -translate-y-2' : ''}`} />
              </div>
            </button>
          </div>
      ...
      <div className="pointer-events-none h-24 sm:h-28 md:h-32 lg:h-36" aria-hidden="true" />
    </>
  );
}
